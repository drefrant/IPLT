...
switch($_GET[act]){
  ...
  default:
    echo "<h2>Agenda</h2>
          <input type=button value='Tambah Agenda' onclick=location.href='?inyong=agenda&act=tambahagenda'>
          <table>
    ...
    while ($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td>$no</td>
                ...
                <td>$tgl_mulai</td>
                <td>$tgl_selesai</td>
                <td><a href=?inyong=agenda&act=editagenda&id=$r[id_agenda]><img src='icon/edit-kecil.png' border=0px width=15px height=16px title='edit'></a> | 
	                  <a href=$aksi?inyong=agenda&act=hapus&id=$r[id_agenda]><img src='icon/delete-kecil.png' border=0px width=15px height=16px title='delete'></a>
		        </tr>";
      $no++;
    }
    echo "</table>";
  ...
  case "tambahagenda":
    echo "<h2>Tambah Agenda</h2>
          <form method=POST action='$aksi?inyong=agenda&act=input'>
          <table>
  ...
  case "editagenda":
    ...
    echo "<h2>Edit Agenda</h2>
          <form method=POST action=$aksi?inyong=agenda&act=update>
