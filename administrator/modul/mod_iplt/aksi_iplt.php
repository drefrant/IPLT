...
if ($inyong=='iplt' AND $act=='hapus'){
  $data=mysql_fetch_array(mysql_query("SELECT GaleriFoto, PetaLokasi, LapSurveyKons FROM DaftIPLT WHERE id='$_GET[id]'"));
  if ($data['GaleriFoto', 'PetaLokasi' , 'LapSurveyKons']!=''){
